...
public class Constants {
    ...
    public static final double EXTRA_LIFE_WIDTH = 20.0;
    public static final double EXTRA_LIFE_HEIGHT = 20.0;
    ...
    public static final double EXTRA_LIFE_INITIAL_X = 475.0;
    public static final double EXTRA_LIFE_INITIAL_Y = 725.0;
